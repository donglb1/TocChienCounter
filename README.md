...
```
toc-chien-counter/
├── App.js                       # tab bar 5 mục + điều hướng luồng con + ErrorBoundary + NewsProvider
...
│   │   ├── draftAnalysis.js     # phân tích đội hình offline (profile + gợi ý ban)
...
│   └── screens/                 # 9 màn (xem bảng tính năng)
